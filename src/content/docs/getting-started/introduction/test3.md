...
```
![Robot Visualization](public/img/image_test3/robot_visualization.png)  
*Figure 1: Robot visualization in Gazebo*

![RQT Interface](public/img/image_test3/interface_rqt.png)  
...
![RViz Mapping Interface](public/img/image_test3/interface_rviz.png)  
...
```
![Teleop Terminal](public/img/image_test3/terminal_commande.png)  
...
![SLAM Map Generated](public/img/image_test3/my_map.png)  
*Figure 5: Map generated by SLAM Toolbox (white = free, black = occupied, gray = unknown)*

![Map YAML File](public/img/image_test3/my_map.yaml)  
